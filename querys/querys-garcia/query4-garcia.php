...
<body>
    ...
    <h2>Resultado:</h2>
    <?php
        $query4 = "SELECT c.fechaPublicacion FROM comentarios c WHERE c.idComentario LIKE  $cid";
        $result = MYSQLI_QUERY($xcon, $query4);

        while($datos = MYSQLI_FETCH_ASSOC($result)) {
            echo "<p>Fecha de publicacion: " . $datos["fechaPublicacion"] . "</p>";
        }
